...
public class Program {
	...
	public static void arrayListCreations() {
		// primitive types and objects
				...
				// Be careful! IF you create a an empty list, you need to define the type in both sides:
				...
				// calls every objects' toString method and returns you a combined string of all the elements.
				...
				// when you remove an element, it returns that element and you can store if you want to use it for later.
